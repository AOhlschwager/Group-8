...
public class sqlFrag extends Fragment {
    ...
    public void method() {
        ...
        if (c == null) {
            ...
            //insert data.
            db.insertReminder("12:00", "Fix this");
            db.insertReminder("12:01", "And this");
            return;
        }
        ...
        for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
            ...
            appendthis(c.getString(c.getColumnIndex(mySQLiteHelper.KEY_TIME)) + " " +
        ...
        if (c.getCount() == 0) {
            ...
            appendthis("Select on 12:00 returned: " +
                    c.getString(c.getColumnIndex(mySQLiteHelper.KEY_TIME)) + " " +  //column 0
                    c.getString(c.getColumnIndex(mySQLiteHelper.KEY_TITLE))            //column 1
            );
        }
